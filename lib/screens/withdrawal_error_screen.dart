...
class WithdrawalErrorScreen extends StatefulWidget {
  final double amount;
  ...
  const WithdrawalErrorScreen({
    ...
    this.errorMessage = 'Network timeout or insufficient mobile money provider balance.',
  });

  @override
  State<WithdrawalErrorScreen> createState() => _WithdrawalErrorScreenState();
}

class _WithdrawalErrorScreenState extends State<WithdrawalErrorScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: [
            // Warm Red Ambient Radial Background Glow
            Positioned(
              top: -40,
              left: 0,
              right: 0,
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text.rich(
                            TextSpan(
                              text: "We couldn't complete your withdrawal of ",
                              ...
                              children: [
                                ...
                                const TextSpan(
                                  text: '.\nYour funds remain safe in your Susu balance. Please try again.',
                                ),
                              ],
                            ),
                            textAlign: TextAlign.center,
